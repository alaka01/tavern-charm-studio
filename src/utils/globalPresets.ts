...
export const GLOBAL_PRESETS: GlobalPreset[] = [
  ...
  },
  {
    ...
    name: '手账风',
    emoji: '📓',
    description: '软萌粉色手账本风格，虚线边框、手绘感，翻页卡片用圆形按钮触发',
    tags: ['卡片气泡', '手账粉', '网格面板', 'Claude 风排版'],
    dialog: {
      bubblePreset: 'card',
      themeColor: '#d946a8',
      avatarMode: 'emoji',
      avatarEmoji: '🌸',
      bubbleBgColor: '#fff5f5',
      useGradient: false,
      borderRadius: 12,
      showBorder: true,
      borderColor: '#f9a8d4',
    ...
    statusPanel: {
      title: '角色状态',
      fields: [
        { id: uuid(), name: '心情', type: 'badge', group: '日记' },
        { id: uuid(), name: '体力', type: 'progress', group: '日记' },
        { id: uuid(), name: '地点', type: 'text', group: '日记' },
    ...
    textEffects: [
      { name: '旁白', matchPattern: 'cn_parens', customRegex: '', color: '#9d174d', fontSize: 14, italic: true, bold: false, opacity: 0.85, showBg: false, bgColor: '' },
      { name: '心声', matchPattern: 'asterisk', customRegex: '', color: '#be185d', fontSize: 14, italic: false, bold: false, opacity: 0.9, showBg: true, bgColor: 'rgba(251,207,232,0.3)' },
    ],
    flipCard: {
      typography: { ...TYPOGRAPHY_PRESETS.claude },
      cardBorder: true,
